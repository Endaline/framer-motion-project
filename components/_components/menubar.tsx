          ...
          <NavigationMenuContent>
            <div className="flex">
              ...
              <div>
                <ul className="grid p-2 md:w-[400px] lg:w-[250px] hover:cursor-pointer border-r">
                  <div className="flex items-center gap-1 hover:bg-gray-400/10 p-1 rounded-sm">
                    <FaHtml5 className="text-2xl mr-2 text-yellow-600" />
                  ...
                  <div className="flex items-center gap-1 hover:bg-gray-400/10 p-1 rounded-sm">
                    <IoLogoCss3 className="text-2xl mr-2 text-blue-600" />
                  ...
                  <div className="flex items-center gap-1 hover:bg-gray-400/10 p-1 rounded-sm">
                    <TbBrandJavascript className="text-2xl mr-2 text-red-600" />
                    <div>
                      <a>Javascript</a>
                      <p className="text-gray-400 text-sm font-light">
                        The working appliances in the building
                      </p>
                    </div>
                  </div>
                </ul>
